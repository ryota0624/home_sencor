...
/***/ function(module, exports) {
	...
	function fetchNcmb(key, pass) {
	  ...
	  var ncmb = new NCMB(key, pass);
	  var TempClass = ncmb.DataStore("Temp");
	  var dataSet;
	  var labels;
	  return new Promise(function (resolve) {
	    TempClass.fetchAll().then(function (res) {
	      var labels = res.map(function (o) {
	        return formatDate(new Date(o.createDate), "MM月DD日hh時mm分");
	      });
	      var dataSet = res.map(function (o) {
	        return o.celsius;
	      });
	      var table = res.map(function (o) {
	        return {
	          date: formatDate(new Date(o.createDate), "MM月DD日hh時mm分"),
	          celsius: o.celsius
	        };
	      });
	      resolve({ labels: labels, dataSet: dataSet, table: table });
	    });
	  });
	}
	
	var Temp = function () {
	  function Temp(key, pass) {
	    var _this = this;
	    ...
	    this._temp = [];
	    this._store.fetchAll().then(function (res) {
	      _this._temp = res;
	    });
	  }
	  ...
	  _createClass(Temp, [{
	    ...
	    value: function labels() {
	      return this._temp.map(function (o) {
	        return formatDate(new Date(o.createDate), "MM月DD日hh時mm分");
	      });
	    }
	  }, {
	...
	var graph = function graph() {
	  fetchNcmb(window.ni.key, window.ni.pass).then(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module), (function() { return this; }()), __webpack_require__(7)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableComponent = {
	  ...
	  view: function view(ctrl) {
	    console.log(graph);
	    var rows = ctrl.list().map(function (row) {
	      return m.component(itemComponent, { row: row });
	    });
	    return m("table", { class: "table" }, [m("thead", m("tr", [m("th", "data"), m("th", "cel")])), m("tbody", rows)]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var m = __webpack_require__(1);
	var links = [{ link: "/", label: "graph" }, { link: "/table", label: "table" }, { link: "/track", label: "track" }];

...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module), (function() { return this; }()), __webpack_require__(6)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var itemComponent = _require.itemComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var musicComponent = {
	  ...
	  view: function view(ctrl) {
	    ...
	    return m("div", [m.component(navBar, {}), app]);
	  }
	};
	...
	var Music = function () {
	  ...
	  _createClass(Music, [{
	    ...
	    value: function search(keyword) {
	      ...
	      searchMusic(keyword).then(function (res) {
	        return _this._tracks = res;
	      }).then(callback).catch(function (res) {
